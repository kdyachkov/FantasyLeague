...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Team.money_to_spend'
        db.alter_column(u'fantasy_league_team', 'money_to_spend', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
    ...
    models = {
        ...
        u'fantasy_league.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'money_to_spend': ('django.db.models.fields.DecimalField', [], {'default': "'50.0'", 'max_digits': '4', 'decimal_places': '2'}),
