...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.money_to_spend'
        db.add_column(u'fantasy_league_team', 'money_to_spend',
                      self.gf('django.db.models.fields.DecimalField')(default=50.0, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.money_to_spend'
        db.delete_column(u'fantasy_league_team', 'money_to_spend')
    ...
    models = {
        ...
        u'fantasy_league.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'money_to_spend': ('django.db.models.fields.DecimalField', [], {'default': '50.0', 'max_digits': '3', 'decimal_places': '2'}),
