...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.captain'
        db.alter_column(u'fantasy_league_team', 'captain_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fantasy_league.Player']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Team.captain'
        raise RuntimeError("Cannot reverse this migration. 'Team.captain' and its values cannot be restored.")
