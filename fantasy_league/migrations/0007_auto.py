...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field weekly_points on 'Player'
        db.create_table(u'fantasy_league_player_weekly_points', (
        ...
        db.create_unique(u'fantasy_league_player_weekly_points', ['player_id', 'weeklypoints_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field weekly_points on 'Player'
        db.delete_table('fantasy_league_player_weekly_points')
    ...
    models = {
        ...
        u'fantasy_league.player': {
            ...
            'weekly_points': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'points'", 'symmetrical': 'False', 'to': u"orm['fantasy_league.WeeklyPoints']"})
        },
