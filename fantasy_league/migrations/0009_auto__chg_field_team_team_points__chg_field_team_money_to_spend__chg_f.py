...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fantasy_league_team', 'team_points', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Team.money_to_spend'
        db.alter_column(u'fantasy_league_team', 'money_to_spend', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'Membership.amount_paid'
        db.alter_column(u'fantasy_league_membership', 'amount_paid', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'Player.current_value'
        db.alter_column(u'fantasy_league_player', 'current_value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'Player.init_value'
        db.alter_column(u'fantasy_league_player', 'init_value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Team.team_points'
        db.alter_column(u'fantasy_league_team', 'team_points', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'Team.money_to_spend'
        db.alter_column(u'fantasy_league_team', 'money_to_spend', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'Membership.amount_paid'
        db.alter_column(u'fantasy_league_membership', 'amount_paid', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'Player.current_value'
        db.alter_column(u'fantasy_league_player', 'current_value', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'Player.init_value'
        db.alter_column(u'fantasy_league_player', 'init_value', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
    ...
    models = {
        ...
        u'fantasy_league.team': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'money_to_spend': ('django.db.models.fields.DecimalField', [], {'default': "'50.0'", 'max_digits': '6', 'decimal_places': '2'}),
